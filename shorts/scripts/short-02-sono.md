...
## Título do Short
`SALMO 121 | Oração Para Dormir em Paz Toda Noite`

## Hashtags
`#Salmo121` `#OraçãoParaDormir` `#DescansoEmDeus` `#OraçãoNoturna` `#VozDeFé`
...
```
Cinematic dark bedroom atmosphere. Soft golden candlelight casting warm glow on white linen bedsheets. A single open Bible resting on a wooden nightstand. Thin wisps of smoke from an extinguished candle rising gently. Window showing deep night sky with a single bright star. No people, no text. Atmosphere: peaceful, holy, quiet rest. 9:16 vertical, photorealistic, ultra-detailed.
```
