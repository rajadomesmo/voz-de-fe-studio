...
```
Cinematic dark healing scene. Gentle hands — no faces visible — resting open and upward on a dark wooden surface, bathed in a soft descending beam of warm golden-white light from above. The light disperses into tiny luminous particles floating upward like a heavenly breath. Background: deep shadow with a faint cross outline glowing amber. No people visible above wrists, no text. Atmosphere: divine healing, surrender, sacred restoration. 9:16 vertical, photorealistic, ultra-detailed.
```
